$.fn.xxcity = function(pName,cName,aName){

    var p = $(this).find('select[lay-filter=xprovince]');

    var c = $(this).find('select[lay-filter=xcity]');

    var a = $(this).find('select[lay-filter=xarea]');
    ...
    form.on('select(xprovince)', function(data){
        pName = data.value;
        showP(provinceList);
        showC(cityList);
        showA(areaList);
    ...
    form.on('select(xcity)', function(data){
        cName = data.value;
        showC(cityList);
        showA(areaList);
        form.render('select');
